using Axerrio.Client.Xamarin.Services;
...
namespace Axerrio.Client.Xamarin
{
    class Program
    {
        static OidcClient _oidcClient;
        static HttpClient _apiClient = new HttpClient { BaseAddress = new Uri("http://localhost:5001" + "/identity") };
